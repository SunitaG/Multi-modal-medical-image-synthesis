...
class TrainOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--resize_size', type=int, default=240, help='resized image size for training')
        self.parser.add_argument('--crop_size', type=int, default=220, help='cropped image size for training')
        ...
        self.parser.add_argument('--multi_modal', type=int, default=0, help='1 if using multi modal data (Flair,T1) '
                                                                            'else 0')
        ...
        self.parser.add_argument('--n_ep', type=int, default=180, help='number of epochs')
        self.parser.add_argument('--n_ep_decay', type=int, default=45,
...
class TestOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--name', type=str, default='trial', help='folder name to save outputs')
        self.parser.add_argument('--result_dir', type=str, default='../outputs',
                                 help='path for saving result images and models')
        ...
        self.parser.add_argument('--resume', type=str, required=True,
                                 help='specified the dir of saved models for resume the training')
        self.parser.add_argument('--gpu', type=int, default=0, help='gpu')
        self.parser.add_argument('--average', type=int, default=1, help='displays the output after combining attribures '
                                                                        'from multiple test images')
