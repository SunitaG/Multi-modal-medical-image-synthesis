...
class G(nn.Module):
    def __init__(self, output_dim_a, output_dim_b, nz):
        ...
        tch = tch // 2
        decA6 = []
        decA6 = [INSResBlock(tch, tch), INSResBlock(tch, tch),
                 ReLUINSConvTranspose2d(tch, tch // 2, kernel_size=3, stride=2, padding=1, output_padding=1)]
        tch = tch // 2
        ...
        tch = tch // 2
        decB6 = []
        decB6 += [INSResBlock(tch, tch), INSResBlock(tch, tch),
                  ReLUINSConvTranspose2d(tch, tch // 2, kernel_size=3, stride=2, padding=1, output_padding=1)]
        tch = tch // 2
...
class G_concat(nn.Module):
    def __init__(self, output_dim_a, output_dim_b, nz):
        ...
        tch = tch // 2
        tch = tch + self.nz
        decA3 = [INSResBlock(tch, tch), INSResBlock(tch, tch),
                 ReLUINSConvTranspose2d(tch, tch // 2, kernel_size=3, stride=2, padding=1, output_padding=1)]
        tch = tch // 2
        tch = tch + self.nz
        ...
        tch = tch // 2
        tch = tch + self.nz
        decB3 = [INSResBlock(tch, tch), INSResBlock(tch, tch),
                 ReLUINSConvTranspose2d(tch, tch // 2, kernel_size=3, stride=2, padding=1, output_padding=1)]
        tch = tch // 2
        tch = tch + self.nz
